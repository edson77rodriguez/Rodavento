          ...
          <g transform="translate(-1869.000000, -293.000000)">
            <g transform="translate(1716.000000, 291.000000)">
              <g transform="translate(153.000000, 2.000000)">
                ...
                <path class="color-background" d="M40.25,14 L24.5,14 C23.53225,14 22.75,14.78225 22.75,15.75 L22.75,38.5 L19.25,38.5 L19.25,22.75 C19.25,21.78225 18.46775,21 17.5,21 L1.75,21 C0.78225,21 0,21.78225 0,22.75 L0,40.25 C0,41.21775 0.78225,42 1.75,42 L40.25,42 C41.21775,42 42,41.21775 42,40.25 L42,15.75 C42,14.78225 41.21775,14 40.25,14 Z"></path>
              </g>
            </g>
          </g>
        </g>
...
<li class="nav-item {{ Request::is('guias*') ? 'active' : '' }}">
...
<li class="nav-item {{ Request::is('encargado*') ? 'active' : '' }}">
...
<li class="nav-item {{ Request::is('supervisor*') ? 'active' : '' }}">
  <a class="nav-link" href="{{ route('supervisores.index') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
...
<li class="nav-item {{ Request::is('tipo_hs*') ? 'active' : '' }}">
  <a class="nav-link" href="{{ route('tipo_hs.index') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
        <title>Tipo habilidades</title>
        <g fill="#FFFFFF" fill-rule="nonzero">
          <g transform="translate(-1869.000000, -293.000000)">
            <g transform="translate(1716.000000, 291.000000)">
              <g transform="translate(153.000000, 2.000000)">
    ...
    <span class="nav-link-text ms-1">Tipo habilidades</span>
  </a>
</li>
...
<li class="nav-item {{ Request::is('asignar_habilidades*') ? 'active' : '' }}">
  <a class="nav-link" href="{{ route('asignar_habilidades.index') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      <svg width="12px" height="12px" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Inventario</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Valle Roda Vento</li>
          </ol>
